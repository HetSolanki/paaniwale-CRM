        ...
        <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
          <div className="mb-8 max-w-screen-md lg:mb-16">
            <h2 className="mb-4 text-4xl font-extrabold text-gray-900 dark:text-white">
              Designed for water bottle supply businesses
            </h2>
            <p className="text-gray-500 sm:text-xl dark:text-gray-400">
              At Paani Wale, we focus on providing solutions that streamline the
              billing and supply management for water bottle suppliers.
            </p>
          </div>
          <div className="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
            <div>
              <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                <svg
                  className="w-5 h-5 text-blue-700 lg:w-6 lg:h-6 dark:text-primary-300"
                  fill="currentColor"
                  viewBox="0 0 20 20"
                  xmlns="http://www.w3.org/2000/svg"
                >
              ...
              <p className="text-gray-500 dark:text-gray-400">
                Manage customer details, orders, and billing with ease.
              </p>
            </div>
            <div>
              <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
              ...
              <p className="text-gray-500 dark:text-gray-400">
                Automate monthly billing and payment tracking to save time and
                reduce errors.
              </p>
            </div>
            <div>
              ...
              <p className="text-gray-500 dark:text-gray-400">
                Track your revenue and financial performance effortlessly.
              </p>
            </div>
            {/* <div>
              <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
      ...
      <section className="bg-white dark:bg-gray-900">
        <div className="gap-16 items-center py-8 px-4 mx-auto max-w-screen-xl lg:grid lg:grid-cols-2 lg:py-16 lg:px-6">
          <div className="font-light text-gray-500 sm:text-lg dark:text-gray-400">
            ...
            <p className="mb-4">
              We provide a comprehensive suite of features designed to
              streamline your water bottle supply business.
            </p>
            <h2 className="mb-4 text-2xl font-extrabold text-gray-900 dark:text-white">
              Easy Setup
            </h2>
            <p className="mb-4">
              Quick and easy setup process to get you started in no time.
            </p>
      ...
      {/* <section className="bg-gray-50 dark:bg-gray-800">
        <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
          <div className="max-w-screen-lg text-gray-500 sm:text-lg dark:text-gray-400">
            ...
            <a
              href="#"
              className="inline-flex items-center font-medium text-blue-700 hover:text-primary-800 dark:text-primary-500 dark:hover:text-blue-700"
            >
              Learn more
              <svg
        ...
        <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
          <div className="mx-auto max-w-screen-sm text-center">
            ...
            <p className="mb-6 font-light text-gray-500 dark:text-gray-400 md:text-lg">
              Try Paani Wale Platform for 2 days. No Payment required.
            </p>
            <a
              href="#"
              className="text-white bg-blue-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-700 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-primary-800"
            >
          ...
          <div className="border-t border-gray-800 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
            <div className="text-gray-400 text-sm mb-4 md:mb-0">
              <p>
                ...
                Reserved. | Built with ❤️ for Water Suppliers Inc
              </p>
            </div>
